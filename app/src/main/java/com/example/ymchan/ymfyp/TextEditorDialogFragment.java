 ...
 *
 * StickerBSFragment is fragment for text.
 * referenced from PhotoEditor test app.
 * Original: Created by Burhanuddin Rashid on 1/16/2018.
 */
public class TextEditorDialogFragment extends DialogFragment {
    ...
    //Same as above, but for fragment.
    public static TextEditorDialogFragment show(@NonNull FragmentActivity fragActivity,
                                                @NonNull String inputText,
                                                @ColorInt int colorCode) {
        Bundle args = new Bundle();
        args.putString(EXTRA_INPUT_TEXT, inputText);
        ...
        TextEditorDialogFragment fragment = new TextEditorDialogFragment();
        fragment.setArguments(args);
        fragment.show(fragActivity.getSupportFragmentManager(), TAG);
        return fragment;
    }
    ...
    public static TextEditorDialogFragment show(@NonNull FragmentActivity fragActivity) {
        return show(fragActivity,
                "", ContextCompat.getColor(fragActivity, R.color.white));
    }
